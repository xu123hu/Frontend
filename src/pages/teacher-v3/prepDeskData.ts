...
const FIG_ELLIPSE_FOCI = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 220"><ellipse cx="180" cy="110" rx="150" ry="88" fill="rgba(79,70,229,0.06)" stroke="#4f46e5" stroke-width="2"/><circle cx="60" cy="110" r="4.5" fill="#0891b2"/><circle cx="300" cy="110" r="4.5" fill="#0891b2"/><line x1="60" y1="110" x2="230" y2="38" stroke="#0891b2" stroke-width="1.4" stroke-dasharray="5 4"/><line x1="300" y1="110" x2="230" y2="38" stroke="#0891b2" stroke-width="1.4" stroke-dasharray="5 4"/><circle cx="230" cy="38" r="4" fill="#4f46e5"/><text x="52" y="132" font-size="15" fill="#0e7490">F1</text><text x="294" y="132" font-size="15" fill="#0e7490">F2</text><text x="238" y="34" font-size="15" fill="#4f46e5">M</text><text x="150" y="204" font-size="13" fill="#64748b">|MF1|+|MF2| = 2a</text><line x1="60" y1="110" x2="300" y2="110" stroke="#94a3b8" stroke-width="1"/><text x="168" y="104" font-size="12" fill="#64748b">2c</text></svg>'
const FIG_ELLIPSE_AB = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200"><ellipse cx="180" cy="100" rx="150" ry="86" fill="none" stroke="#4f46e5" stroke-width="2"/><line x1="30" y1="100" x2="330" y2="100" stroke="#94a3b8" stroke-width="1"/><line x1="180" y1="6" x2="180" y2="194" stroke="#94a3b8" stroke-width="1"/><text x="172" y="90" font-size="13" fill="#64748b">O</text><text x="22" y="88" font-size="13" fill="#4f46e5">A1</text><text x="322" y="88" font-size="13" fill="#4f46e5">A2</text><text x="166" y="14" font-size="13" fill="#4f46e5">B2</text><text x="166" y="188" font-size="13" fill="#4f46e5">B1</text><text x="52" y="196" font-size="13" fill="#64748b">|OA1| = a</text></svg>'
